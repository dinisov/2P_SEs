...
parfor xInd = 1:xSize
    ...
    for yInd = 1:ySize
        ...
        for zInd = 1:zSize
           ...
           r_squared_slrp(xInd,yInd,zInd) = 1-(sse_slrp/sse_total);
           r_squared_lrpr(xInd,yInd,zInd) = 1-(sse_lrpr/sse_total);
           r_squared_weird(xInd,yInd,zInd) = 1-(sse_weird/sse_total);
           r_squared_overall(xInd,yInd,zInd) = 1-(sse_overall/sse_total);
           r_squared_ephys(xInd,yInd,zInd) = 1-(sse_ephys/sse_total);
